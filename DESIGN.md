...
When handing off designs or bringing in new engineers (or AI assistants), use the following base prompt to ensure absolute adherence to the Airix design system.
